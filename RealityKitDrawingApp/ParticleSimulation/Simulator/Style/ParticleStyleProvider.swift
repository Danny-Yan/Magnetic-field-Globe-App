...
/// Receives input events and generates a `ParticlePoint` for that event.
///
/// "Drawing Styles" can modify attributes such as color as the curve is drawn.
struct ParticleStyleProvider {
    ...
    func styleInput(position: SIMD3<Float>, speed: Float, settings: Settings) -> ParticlePoint {

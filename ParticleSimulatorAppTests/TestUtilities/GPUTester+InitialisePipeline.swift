//
//  GPUTester+InitialisePipeline.swift
//  ParticleSimulatorApp
//
//  Created by DY on 12/9/2026.
...
extension GPUTester {
    /// GPU Function to call the initialise pipeline once
    ...
    mutating func initialiseMagneticModel(chosenModel: MagneticModelVersion) async throws -> (MTLBuffer, UnsafeMutablePointer<MagneticFieldModel>) {
        ...
        let magneticModelPointer = createSingleTypeBufPointer(buf: &magneticModelBuffer, of: MagneticFieldModel.self)
